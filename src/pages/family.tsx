    ...
    semesters: [
      {
        ...
        classes: [
          ...
          { cls: '2-А клас', href: '/docs/cons-1-1.pdf' },
          { cls: '2-Б клас', href: '/docs/cons-1-2.pdf' },
          { cls: '3-А клас', href: '/docs/cons-1-3.pdf' },
          { cls: '3-Б клас', href: '/docs/cons-1-3.pdf' },
          { cls: '4-А клас', href: '/docs/cons-1-4.pdf' },
          { cls: '4-Б клас', href: '/docs/cons-1-4.pdf' },
